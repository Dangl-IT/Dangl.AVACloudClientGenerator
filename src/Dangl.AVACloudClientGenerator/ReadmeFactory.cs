...
{
    public static class ReadmeFactory
    {
        public static string GetReadmeContent(string packageDetails)
        {
            var readmeContent = @"# Dangl.AVACloud Client
...
https://github.com/Dangl-IT/Dangl.AVACloudClientGenerator" + Environment.NewLine;


            if (!string.IsNullOrWhiteSpace(packageDetails))
            {
                readmeContent += Environment.NewLine + packageDetails + Environment.NewLine;
            }
